...
export const ScanPage = () => {
  ...
  const handleUploadAndAnalyze = () => {
    ...
    setIsAnalyzing(true);
    // Navigate to animated Stitch Analysis Loading page
    navigate('/analysis');
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-extrabold text-white">{t('scan.title')}</h1>
        <p className="text-xs sm:text-sm text-slate-400 mt-1">
          Upload or capture a leaf image for OpenCV preprocessing, AI disease prediction, and severity estimation.
        </p>
      </div>
